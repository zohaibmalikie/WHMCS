...
$_ADMINLANG['user']['chooseUser'] = "Please choose an existing user, or enter a new email address to send an invite";
$_ADMINLANG['user']['anInviteWillBeSent'] = "As you entered a new email address, an invite will be sent. The recipient will need to accept it in order to create an account.";
